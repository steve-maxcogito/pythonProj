...
outerDictionary = jsonDict
innerDictionary = jsonDict['Data']
dataDictList = jsonDict['Data']['Data']
print("\n***********")
print("Outer Dictionary:")
print(outerDictionary)
print("\n***********")
print("Inner Dictionary")
...
outHeaderFileInfo.append("Data file: " + fileval)
...
csvval2 = input("Please enter a SECOND filename {.csv} to be used to save the JSON output of the API (as a CSV file):")

csvObj2 = Path.cwd() / csvval2

testDict = {}
testDict = writeCSVFile(jsonDict, fileObj, csvObj2, urlObj)
